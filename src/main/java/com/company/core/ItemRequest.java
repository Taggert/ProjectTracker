...
public class ItemRequest {
    ...
    private static ResponseEntity<ItemInst> getAllItems(){
        ...
        InputStream is = ItemRequest.class.getResourceAsStream("/app.properties");
        try {
            properties.load(is);
        } catch (IOException e) {
        ...
        try{
            response = restTemplate.exchange(properties.getProperty("urlItem"), HttpMethod.GET, entity, ItemInst.class );
