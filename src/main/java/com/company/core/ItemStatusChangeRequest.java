...
@Service
public class ItemStatusChangeRequest implements ItemStatusChangeRequestInt {
    ...
    public void changeStatus() {
        ...
        try {
            response = restTemplate.exchange(url, HttpMethod.PUT, entity, ItemInst.class, urlParams);
